...
![img](https://cdn.xiaolincoding.com//picgo/1760279156405-b897d95b-cff2-4240-8e86-bc54eb6e20b1.png)
...
**首先最核心的区别是它们的调度模型不一样**。Java的线程是操作系统级别的线程，也就是我们说的内核线程，一个Java线程对应一个操作系统线程，它的创建、销毁、调度都是由操作系统内核来管理的。
