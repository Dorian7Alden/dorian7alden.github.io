...
![img](https://cdn.xiaolincoding.com//picgo/image-20240820112656259.png)
...
线程管理也是重要的交互点。Java里创建的线程对应操作系统的原生线程，在Linux上会调用pthread_create来创建线程。线程的调度、同步机制，比如synchronized底层用的互斥锁，最终都是由操作系统来管理的。
...
![img](https://cdn.xiaolincoding.com//picgo/1766932722511-525ecd38-9480-41b4-9a9e-3d131c7bb1c4.png)
