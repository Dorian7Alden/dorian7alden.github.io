...
<div class="about-hero">
  <div class="about-avatar">
    <svg viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="48" cy="48" r="48" fill="var(--brand-soft)"/>
      <circle cx="48" cy="36" r="17" fill="var(--brand)" opacity="0.55"/>
      <ellipse cx="48" cy="74" rx="28" ry="14" fill="var(--brand)" opacity="0.35"/>
    </svg>
  </div>
...
<div class="about-section">
  ...
  <div class="contact-links">
    <a href="https://github.com/Seniorsy" target="_blank" rel="noopener" class="contact-link">
